...
DROP TABLE IF EXISTS REF_CPTYS;
DROP TABLE IF EXISTS REF_AGREEMENT;
...
CREATE TABLE REF_CPTYS (
    cm_id VARCHAR(255) PRIMARY KEY,
    name VARCHAR(255),
    state VARCHAR(255),
    client_cm_id VARCHAR(255),
    lookup VARCHAR(255)
);
...
CREATE TABLE REF_AGREEMENT (
    cm_id VARCHAR(255) PRIMARY KEY,
    name VARCHAR(255),
    principal_cm_id VARCHAR(255),
    cpty_cm_id VARCHAR(255),
    state VARCHAR(255),
    client_cm_id VARCHAR(255),
